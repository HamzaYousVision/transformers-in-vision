...
from vision_transformer_pytorch.utils import (get_width_and_height_from_size, load_pretrained_weights,
                    get_model_params)
...
class VisionTransformer(nn.Module):
    ...
    def extract_features(self, x):
        ...
        # transformer
        feat, att = self.transformer(emb)
        return feat, att

    def forward(self, x):
        feat, atts = self.extract_features(x)
